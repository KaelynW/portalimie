...
class __TwigTemplate_111625fcf11d65a69b29badcffda99275e8fd67006e205d4c48e48be029236ff extends Twig_Template
{
    ...
    <body>
        ...
        if ((isset($context["enableSandbox"]) ? $context["enableSandbox"] : null)) {
            ...
            echo ">XML</option>
                    ...
                    ";
            // line 30
            if (((isset($context["authentication"]) ? $context["authentication"] : null) && twig_in_filter($this->getAttribute((isset($context["authentication"]) ? $context["authentication"] : null), "delivery", array()), array(0 => "query", 1 => "http_basic", 2 => "header")))) {
                // line 31
