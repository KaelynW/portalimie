...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // imie_evaluate_default_index
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'imie_evaluate_default_index')), array (  '_controller' => 'Imie\\EvaluateBundle\\Controller\\DefaultController::indexAction',));
        }

        // imie_www_default
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'imie_www_default');
            }

            return array (  '_controller' => 'Imie\\CoreBundle\\Controller\\DefaultController::indexAction',  '_route' => 'imie_www_default',);
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/imie/core')) {
                if (0 === strpos($pathinfo, '/admin/imie/core/student')) {
                    // admin_imie_core_student_list
                    if ($pathinfo === '/admin/imie/core/student/list') {
                        return array (  '_controller' => 'Imie\\CoreBundle\\Controller\\StudentAdminController::listAction',  '_sonata_admin' => 'sonata.admin.student',  '_sonata_name' => 'admin_imie_core_student_list',  '_route' => 'admin_imie_core_student_list',);
                    }

                    // admin_imie_core_student_create
                    if ($pathinfo === '/admin/imie/core/student/create') {
                        return array (  '_controller' => 'Imie\\CoreBundle\\Controller\\StudentAdminController::createAction',  '_sonata_admin' => 'sonata.admin.student',  '_sonata_name' => 'admin_imie_core_student_create',  '_route' => 'admin_imie_core_student_create',);
                    }

                    // admin_imie_core_student_batch
                    if ($pathinfo === '/admin/imie/core/student/batch') {
                        return array (  '_controller' => 'Imie\\CoreBundle\\Controller\\StudentAdminController::batchAction',  '_sonata_admin' => 'sonata.admin.student',  '_sonata_name' => 'admin_imie_core_student_batch',  '_route' => 'admin_imie_core_student_batch',);
                    }

                    // admin_imie_core_student_edit
                    if (preg_match('#^/admin/imie/core/student/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_student_edit')), array (  '_controller' => 'Imie\\CoreBundle\\Controller\\StudentAdminController::editAction',  '_sonata_admin' => 'sonata.admin.student',  '_sonata_name' => 'admin_imie_core_student_edit',));
                    }

                    // admin_imie_core_student_delete
                    if (preg_match('#^/admin/imie/core/student/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_student_delete')), array (  '_controller' => 'Imie\\CoreBundle\\Controller\\StudentAdminController::deleteAction',  '_sonata_admin' => 'sonata.admin.student',  '_sonata_name' => 'admin_imie_core_student_delete',));
                    }

                    // admin_imie_core_student_show
                    if (preg_match('#^/admin/imie/core/student/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_student_show')), array (  '_controller' => 'Imie\\CoreBundle\\Controller\\StudentAdminController::showAction',  '_sonata_admin' => 'sonata.admin.student',  '_sonata_name' => 'admin_imie_core_student_show',));
                    }

                    // admin_imie_core_student_export
                    if ($pathinfo === '/admin/imie/core/student/export') {
                        return array (  '_controller' => 'Imie\\CoreBundle\\Controller\\StudentAdminController::exportAction',  '_sonata_admin' => 'sonata.admin.student',  '_sonata_name' => 'admin_imie_core_student_export',  '_route' => 'admin_imie_core_student_export',);
                    }

                    // admin_imie_core_student_acl
                    if (preg_match('#^/admin/imie/core/student/(?P<id>[^/]++)/acl$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_student_acl')), array (  '_controller' => 'Imie\\CoreBundle\\Controller\\StudentAdminController::aclAction',  '_sonata_admin' => 'sonata.admin.student',  '_sonata_name' => 'admin_imie_core_student_acl',));
                    }

                }

                if (0 === strpos($pathinfo, '/admin/imie/core/teacher')) {
                    // admin_imie_core_teacher_list
                    if ($pathinfo === '/admin/imie/core/teacher/list') {
                        return array (  '_controller' => 'Imie\\CoreBundle\\Controller\\TeacherAdminController::listAction',  '_sonata_admin' => 'sonata.admin.teacher',  '_sonata_name' => 'admin_imie_core_teacher_list',  '_route' => 'admin_imie_core_teacher_list',);
                    }

                    // admin_imie_core_teacher_create
                    if ($pathinfo === '/admin/imie/core/teacher/create') {
                        return array (  '_controller' => 'Imie\\CoreBundle\\Controller\\TeacherAdminController::createAction',  '_sonata_admin' => 'sonata.admin.teacher',  '_sonata_name' => 'admin_imie_core_teacher_create',  '_route' => 'admin_imie_core_teacher_create',);
                    }

                    // admin_imie_core_teacher_batch
                    if ($pathinfo === '/admin/imie/core/teacher/batch') {
                        return array (  '_controller' => 'Imie\\CoreBundle\\Controller\\TeacherAdminController::batchAction',  '_sonata_admin' => 'sonata.admin.teacher',  '_sonata_name' => 'admin_imie_core_teacher_batch',  '_route' => 'admin_imie_core_teacher_batch',);
                    }

                    // admin_imie_core_teacher_edit
                    if (preg_match('#^/admin/imie/core/teacher/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_teacher_edit')), array (  '_controller' => 'Imie\\CoreBundle\\Controller\\TeacherAdminController::editAction',  '_sonata_admin' => 'sonata.admin.teacher',  '_sonata_name' => 'admin_imie_core_teacher_edit',));
                    }

                    // admin_imie_core_teacher_delete
                    if (preg_match('#^/admin/imie/core/teacher/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_teacher_delete')), array (  '_controller' => 'Imie\\CoreBundle\\Controller\\TeacherAdminController::deleteAction',  '_sonata_admin' => 'sonata.admin.teacher',  '_sonata_name' => 'admin_imie_core_teacher_delete',));
                    }

                    // admin_imie_core_teacher_show
                    if (preg_match('#^/admin/imie/core/teacher/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_teacher_show')), array (  '_controller' => 'Imie\\CoreBundle\\Controller\\TeacherAdminController::showAction',  '_sonata_admin' => 'sonata.admin.teacher',  '_sonata_name' => 'admin_imie_core_teacher_show',));
                    }

                    // admin_imie_core_teacher_export
                    if ($pathinfo === '/admin/imie/core/teacher/export') {
                        return array (  '_controller' => 'Imie\\CoreBundle\\Controller\\TeacherAdminController::exportAction',  '_sonata_admin' => 'sonata.admin.teacher',  '_sonata_name' => 'admin_imie_core_teacher_export',  '_route' => 'admin_imie_core_teacher_export',);
                    }

                    // admin_imie_core_teacher_acl
                    if (preg_match('#^/admin/imie/core/teacher/(?P<id>[^/]++)/acl$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_teacher_acl')), array (  '_controller' => 'Imie\\CoreBundle\\Controller\\TeacherAdminController::aclAction',  '_sonata_admin' => 'sonata.admin.teacher',  '_sonata_name' => 'admin_imie_core_teacher_acl',));
                    }

                }

                if (0 === strpos($pathinfo, '/admin/imie/core/user')) {
                    // admin_imie_core_user_list
                    if ($pathinfo === '/admin/imie/core/user/list') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_imie_core_user_list',  '_route' => 'admin_imie_core_user_list',);
                    }

                    // admin_imie_core_user_create
                    if ($pathinfo === '/admin/imie/core/user/create') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_imie_core_user_create',  '_route' => 'admin_imie_core_user_create',);
                    }

                    // admin_imie_core_user_batch
                    if ($pathinfo === '/admin/imie/core/user/batch') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_imie_core_user_batch',  '_route' => 'admin_imie_core_user_batch',);
                    }

                    // admin_imie_core_user_edit
                    if (preg_match('#^/admin/imie/core/user/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_user_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_imie_core_user_edit',));
                    }

                    // admin_imie_core_user_delete
                    if (preg_match('#^/admin/imie/core/user/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_user_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_imie_core_user_delete',));
                    }

                    // admin_imie_core_user_show
                    if (preg_match('#^/admin/imie/core/user/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_user_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_imie_core_user_show',));
                    }

                    // admin_imie_core_user_export
                    if ($pathinfo === '/admin/imie/core/user/export') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_imie_core_user_export',  '_route' => 'admin_imie_core_user_export',);
                    }

                    // admin_imie_core_user_acl
                    if (preg_match('#^/admin/imie/core/user/(?P<id>[^/]++)/acl$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_imie_core_user_acl')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::aclAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_imie_core_user_acl',));
                    }
